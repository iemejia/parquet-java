...
public class CodecFactory implements CompressionCodecFactory {
  ...
  /**
   * Decompresses using airlift's LZ4 decompressor directly with ByteBuffers.
   * The {@link ByteBuffer} overload passes buffers straight through to the native
   * decompressor, avoiding intermediate byte-array copies.
   */
