 ...
 * Covers both the per-value decode entry point ({@code readLong}) and the batch entry
 * point ({@code readLongs}).
 *
 ...
 * </ul>
 *
 * <p>This complements {@link IntEncodingBenchmark#decodeDelta} which only covers INT32.
